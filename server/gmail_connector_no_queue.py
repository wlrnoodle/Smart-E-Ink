...
class Gmail_connector():
    ...
    def __init__(self, creds, satellite_emails = None):
        ...
        #if none satellite emails are provided then use an empty list as defauly
        self.satellite_emails = satellite_emails if satellite_emails is not None else []
    ...
    def pull_attachments(self, userID, ):
        ...
        for idx,message in enumerate(results['messages'][0:11]):
            ...
            # Check if email has parts structure, if not skip this email
            ...
            for parts in message_content['payload']['parts']:
                ...
                if "parts" in parts and len(parts["parts"]) > 0 and "body" in parts["parts"][0] and "data" in parts["parts"][0]["body"]:
                ...
                elif parts['mimeType']=='text/plain' and "body" in parts and "data" in parts["body"]:
